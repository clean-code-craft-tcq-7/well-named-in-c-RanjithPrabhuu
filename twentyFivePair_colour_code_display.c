...
void twentyFivePairColourCodeDisplay(void)
{
  ...
  for(twentyFivePair_colour_code = 1; twentyFivePair_colour_code <= MAX_COLOR_PAIR_SUPPORTED; twentyFivePair_colour_code++)
  {
      memset(twentyFivePair_colour_string_buffer, 0, MAX_COLOR_PAIR_SUPPORTED);
